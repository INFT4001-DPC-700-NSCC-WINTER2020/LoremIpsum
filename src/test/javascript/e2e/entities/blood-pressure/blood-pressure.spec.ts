...
describe('BloodPressure e2e test', () => {
  ...
  it('should create and save BloodPressures', async () => {
    ...
    await bloodPressureComponentsPage.clickOnCreateButton();
    await promise.all([
      bloodPressureUpdatePage.setDatetimeInput('2000-12-31'),
    ...
    expect(await bloodPressureUpdatePage.getDatetimeInput()).to.eq('2000-12-31', 'Expected datetime value to be equals to 2000-12-31');
